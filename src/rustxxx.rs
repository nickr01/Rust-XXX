...
pub struct Protocol {
    ...
    crc_calc_pad: BitCount,
    crc_polynomial: BitMap, // u16,     // CRC-14 polynomial without the leading (MSB) 1
    crc_width: BitCount,
    crc_start: usize,
    crc_xor: usize,
    symbol_bt: f32,
...
impl Protocol {
    ...
    pub const fn _crc_pad_bits(&self) -> BitCount { self.crc_calc_pad }

    pub const fn _crc_polynomial(&self) -> BitMap { self.crc_polynomial }
    pub const fn _crc_width(&self) -> BitCount { self.crc_width }
    pub const fn _crc_start(&self) -> usize { self.crc_start }
    pub const fn _crc_xor(&self) -> usize { self.crc_xor }
...
pub const FT8: Protocol = Protocol {
...
pub const TEST_PROTOCOL: Protocol = FT8;
