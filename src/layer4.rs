...
const _CRC_FT8: crc::Algorithm<u16> = crc::Algorithm {
    width: rustxxx::FT8._crc_width().0 as u8,
    poly: rustxxx::FT8._crc_polynomial().0 as u16,
    init: rustxxx::FT8._crc_start() as u16,
    refin: false,
    refout: false,
    xorout: rustxxx::FT8._crc_xor() as u16,
    check: 0x0,
    residue: 0x0
};

const _FT8CRC: crc::Crc<u16> = crc::Crc::<u16>::new(&_CRC_FT8);
