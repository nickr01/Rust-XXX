...
mod tests {
    ...
    fn test_roundtrip(modem: &mut rustxxx::Modem, l2_tones: &Vec<u8>) {
    ...
    fn test_layer1() {
        ...
        test_roundtrip(&mut modem, &[0u8; rustxxx::TEST_PROTOCOL.nd().0].to_vec());
        test_roundtrip(&mut modem, &[5u8; rustxxx::TEST_PROTOCOL.nd().0].to_vec());

        let mut msg1 = [0u8; rustxxx::TEST_PROTOCOL.nd().0];
        let mut msg2 = [0u8; rustxxx::TEST_PROTOCOL.nd().0];
